...
xALLpos = data.frame(x1 = c(-10), x2 = c(10), x3 = c(10), x4 = c(-10))
...
for( i in 1:end){
 ...
 if( yALLpos$y1[i] >= yALLpos$y4[i] && yALLpos$y1[i] >= yALLpos$y2[i]  ){
  ...
  if(yALLpos$y1[i] < yALLpos$y4[i] && yALLpos$y1[i] >= yALLpos$y2[i] ){
	...
	plot( 0 , 0 , type="l", xlim=c(-10,10), ylim=c(-5,5), xlab="",ylab="", xaxt="n",yaxt="n")
for(i in 1: round(length(xALLpos$x1)/2-111) ){

	matplot(xALLpos$x1[1:i], yALLpos$y1[1:i], type="l", xlim=c(-7,7), ylim=c(-5,5),add=T)
	matplot(xALLpos$x2[1:i], yALLpos$y2[1:i], type="l", xlim=c(-7,7), ylim=c(-5,5),add=T)
	matplot(xALLpos$x3[1:i], yALLpos$y3[1:i], type="l", xlim=c(-7,7), ylim=c(-5,5),add=T)
	matplot(xALLpos$x4[1:i], yALLpos$y4[1:i], type="l", xlim=c(-7,7), ylim=c(-5,5),add=T)
